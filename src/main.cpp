...
#include "file-clones/file-clones.h"
...
void InitializeCommands() {
    ...
    AddCommand("compact-commit-trees", CompactCommitTrees, "Compacts the commit graphs generated by selective-commit-network so that trivial merges are removed");
    ...
    AddCommand("file-clones", NPMPackages, "Analyze file clones.");
}
