...
```{r}
sum(projects$firstCommit == projects$lastCommit)
```


Now we can try different metrics for interesting projects. From Jan's email yesterday - project duration over 365 days and # of commits 
